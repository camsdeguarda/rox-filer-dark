...
static gchar *opt_type_colours[][2] = {
	{"display_err_colour",  COLOR_TYPE_ERROR},
	{"display_unkn_colour", COLOR_TYPE_UNKNOWN},
	{"display_dir_colour",  COLOR_TYPE_DIRECTORY},
	{"display_pipe_colour", COLOR_TYPE_PIPE},
	{"display_sock_colour", COLOR_TYPE_SOCKET},
	{"display_file_colour", COLOR_TYPE_FILE},
	{"display_cdev_colour", COLOR_TYPE_CHAR_DEV},
	{"display_bdev_colour", COLOR_TYPE_BLOCK_DEV},
	{"display_door_colour", COLOR_TYPE_DOOR},
	{"display_exec_colour", COLOR_TYPE_EXEC},
	{"display_adir_colour", COLOR_TYPE_APP_DIR}
};
...
/* Icon theme is now hard-coded to ROX theme only */
...
void type_init(void)
{
	...
	/* Hard-coded to use only ROX theme */
    icon_theme = gtk_icon_theme_new();
...
static void options_changed(void)
{
	...
	SET_OPTION_COLOR(o_type_colours[0], COLOR_TYPE_ERROR);
	SET_OPTION_COLOR(o_type_colours[1], COLOR_TYPE_UNKNOWN);
	SET_OPTION_COLOR(o_type_colours[2], COLOR_TYPE_DIRECTORY);
	SET_OPTION_COLOR(o_type_colours[3], COLOR_TYPE_PIPE);
	SET_OPTION_COLOR(o_type_colours[4], COLOR_TYPE_SOCKET);
	SET_OPTION_COLOR(o_type_colours[5], COLOR_TYPE_FILE);
	SET_OPTION_COLOR(o_type_colours[6], COLOR_TYPE_CHAR_DEV);
	SET_OPTION_COLOR(o_type_colours[7], COLOR_TYPE_BLOCK_DEV);
	SET_OPTION_COLOR(o_type_colours[8], COLOR_TYPE_DOOR);
	SET_OPTION_COLOR(o_type_colours[9], COLOR_TYPE_EXEC);
	SET_OPTION_COLOR(o_type_colours[10], COLOR_TYPE_APP_DIR);
#endif
		...
		GtkIconLookupFlags flags, GError **perror)
{
    ...
    return gtk_icon_theme_load_icon(icon_theme, icon_name, size, flags, perror);
}
