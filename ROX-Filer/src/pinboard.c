...
{
	option_add_string(&o_pinboard_fg_colour, "pinboard_fg_colour", COLOR_PINBOARD_FG);
	option_add_string(&o_pinboard_bg_colour, "pinboard_bg_colour", COLOR_PINBOARD_BG);
	option_add_string(&o_pinboard_shadow_colour, "pinboard_shadow_colour", COLOR_PINBOARD_SHADOW);
