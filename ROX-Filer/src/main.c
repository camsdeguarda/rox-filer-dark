...
int main(int argc, char **argv)
{
	...
	char theme_string[4096];
	snprintf(theme_string, sizeof(theme_string),
		"style \"rox-dark-theme\" {\n"
		"  fg[NORMAL]        = \"%s\"\n"
		"  fg[PRELIGHT]      = \"%s\"\n"
		"  fg[SELECTED]      = \"%s\"\n"
		"  fg[ACTIVE]        = \"%s\"\n"
		...
		"  text[INSENSITIVE] = \"%s\"\n"
		"}\n"
		"class \"GtkWidget\" style \"rox-dark-theme\"\n"
		"\n"
		"style \"rox-default-collection-style\" {\n"
		"  bg[NORMAL] = \"%s\"\n"
		"  fg[NORMAL] = \"%s\"\n"
		"  bg[INSENSITIVE] = \"%s\"\n"
		"  fg[INSENSITIVE] = \"%s\"\n"
		...
		/* Main theme colors */
		COLOR_FG_NORMAL, COLOR_FG_HOVER, COLOR_FG_SELECTED, 
		COLOR_FG_NORMAL, COLOR_FG_INACTIVE,
		COLOR_BG_NORMAL, COLOR_BG_HOVER, COLOR_BG_SELECTED,
		COLOR_BG_INACTIVE, COLOR_BG_ACTIVE,
		COLOR_BASE_NORMAL, COLOR_BASE_HOVER, COLOR_BASE_SELECTED,
		COLOR_BASE_SELECTED, COLOR_BASE_NORMAL,
		COLOR_TEXT_NORMAL, COLOR_TEXT_NORMAL, COLOR_TEXT_NORMAL,
		COLOR_TEXT_NORMAL, COLOR_TEXT_INACTIVE,
		/* Collection style */
		COLOR_COLLECTION_BG, COLOR_COLLECTION_FG,
		COLOR_BG_INACTIVE, COLOR_FG_INACTIVE,
		/* Pinboard style */
		COLOR_PINBOARD_BG
	);
	
	gtk_rc_parse_string(theme_string);
